...
cursor.execute('''CREATE TABLE IF NOT EXISTS QA2
               (id integer, questions text, answers text)''')

cursor.execute('''
               INSERT INTO QA2 (id, questions, answers) VALUES
               (1, 'What is the tallest mountain in the world? A: Mount Everest B: K2 C: Mount Kilimanjaro', "A"),
               (2, 'Who wrote the novel "To Kill a Mockingbird"? A: F. Scott Fitzgerald B: Harper Lee C: John Steinbeck', "B"),
               (3, 'What is the chemical symbol for gold? A: Au B: Ag C: Fe', "A"),
               (4, 'Who painted Starry Night? A: Pablo Picasso, B: Vincent van Gogh, C: Claude Monet', "B"),
...
cursor.execute('''CREATE TABLE IF NOT EXISTS QA3
               (id integer, questions text, answers text)''')

cursor.execute('''
               INSERT INTO QA3 (id, questions, answers) VALUES
               (1, 'What is the tallest mountain in the world? A: Mount Everest B: K2 C: Mount Kilimanjaro', "A"),
               (2, 'Who wrote the novel "To Kill a Mockingbird"? A: F. Scott Fitzgerald B: Harper Lee C: John Steinbeck', "B"),
               (3, 'What is the chemical symbol for gold? A: Au B: Ag C: Fe', "A"),
               (4, 'Who painted Starry Night? A: Pablo Picasso, B: Vincent van Gogh, C: Claude Monet', "B"),
...
cursor.execute('''CREATE TABLE IF NOT EXISTS QA4
               (id integer, questions text, answers text)''')

cursor.execute('''
               INSERT INTO QA4 (id, questions, answers) VALUES
               (1, 'What is the tallest mountain in the world? A: Mount Everest B: K2 C: Mount Kilimanjaro', "A"),
               (2, 'Who wrote the novel "To Kill a Mockingbird"? A: F. Scott Fitzgerald B: Harper Lee C: John Steinbeck', "B"),
               (3, 'What is the chemical symbol for gold? A: Au B: Ag C: Fe', "A"),
               (4, 'Who painted Starry Night? A: Pablo Picasso, B: Vincent van Gogh, C: Claude Monet', "B"),
...
cursor.execute('''CREATE TABLE IF NOT EXISTS QA5
               (id integer, questions text, answers text)''')

cursor.execute('''
               INSERT INTO QA5 (id, questions, answers) VALUES
               (1, 'What is the tallest mountain in the world? A: Mount Everest B: K2 C: Mount Kilimanjaro', "A"),
               (2, 'Who wrote the novel "To Kill a Mockingbird"? A: F. Scott Fitzgerald B: Harper Lee C: John Steinbeck', "B"),
               (3, 'What is the chemical symbol for gold? A: Au B: Ag C: Fe', "A"),
               (4, 'Who painted Starry Night? A: Pablo Picasso, B: Vincent van Gogh, C: Claude Monet', "B"),
